...
| Phase 2 Database Schema | `docs/schema_phase2.md` | Developers, contributors, advisory board | Full schema for Phase 2 entities: Locations, Loans, loan_objects, Donors; Phase 1 migrations, indexes, ER diagram |
| Use Case Library | `docs/use_cases/` | Developers, advisory board, pilot institutions | 42 use cases documenting operational workflows for every module; includes negative cases for constraint and role enforcement |
...
- No schema documents are planned for Phases 3–5. Operations and Data Migration modules will be designed when those phases are scoped; Community & Sustainability (Phase 4) involves no new database entities.
